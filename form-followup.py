...
s.login("dc.python@outlook.com", "Gwh^Fb^%qxbDoNwnMa&3")
...
def censor():
    ...
    if bigtrip == "y":
        ...
        recipients = ["ty.davis@directorschoice.com", "jon.locke@directorschoice.com", "porsha.perez@directorschoice.com", "leanna.perez@directorschoice.com"]
        print("Sending to Ty, Jon and Porsha")
    
    elif bigtrip == "n":
    
        recipients = ["ty.davis@directorschoice.com", "porsha.perez@directorschoice.com", "leanna.perez@directorschoice.com"]
        print("Sending to Ty, Porsha and Leanna")

    elif bigtrip == "":

        recipients = ["ty.davis@directorschoice.com", "porsha.perez@directorschoice.com"]
...
msg['From'] = "dc.python@outlook.com"
...
<p>This will help ensure that we do not have multiple people working on the same registration. Contact <a href="mailto:ty.davis@directorschoice.com">Ty Davis</a> if you have any suggestions or questions.</p>
"""
